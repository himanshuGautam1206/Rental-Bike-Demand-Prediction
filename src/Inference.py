...
#         def user_input(self,):
#             print("Enter correct information to predict Rental Count for a day with respect to time: src")
...
#         ml_model_path = r"D:\new_folder\Bike Demand Prediction\Model\xgboost_regressor_r2_0_928_v1.pkl"
#         standard_scaler_path = r"D:\new_folder\Bike Demand Prediction\Model\sc.pkl"
#         inference = Inference(ml_model_path, standard_scaler_path)
           
#         prediction = inference.prediction()
            
#         print(f"Rented Bike Count prediction with respect to date and time : {round(prediction.tolist()[0])}")
...
class Inference:
    ...
    def user_input(self):
        ...
        print(
            "Enter correct information to predict "
            "Rental Count for a day with respect to time:"
        )
        ...
        df_days = self.days_df(
            str_to_date["week_day"]
        )

        df_for_pred = pd.concat(
            [df_u_input, df_seasons, df_days],
            axis=1
        )
...
if __name__ == "__main__":
    ...
    print(
        f"Rented Bike Count prediction with respect to date and time : "
        f"{round(prediction.tolist()[0])}"
    )